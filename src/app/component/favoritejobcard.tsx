...
type CompanyJobCardType = {
   jobTitle:string,jobType:string,jobDescription:string,
    docId:string,address:string,skills:string,salaryRange:string
}


export default function FavoriteJobCard(
    {jobTitle,jobType,jobDescription,address,skills,salaryRange}:CompanyJobCardType
){
